...
class EmailTemplateController extends Controller
{
    ...
    public function destroy(EmailTemplate $emailTemplate)
    {
        ...
        return redirect()->back()->with('error', __('file is not upload in demo mode.'));
    ...
    public function manageEmailLang($id, $lang = 'en')
    {
        if (\Auth::user()->type == 'super admin') {
            ...
            $EmailTemplates = EmailTemplate::all();
            return view('email_templates.view', compact('emailTemplate', 'languages', 'currEmailTempLang','EmailTemplates'));
        } else {
            return redirect()->back()->with('error', __('Permission denied.'));
        }
    }
    ...
    public function updateEmailSettings(Request $request,$id){
        ...
        )->with('success', __('Email Template details are successfully updated.'));
    }
