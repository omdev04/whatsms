...
@section('action-btn')
    <div class="row gy-4 align-items-center">
        <div class="col-auto">
            <div class="d-flex">
                <a href="{{ route('shipping.export') }}  " class="btn btn-sm btn-icon  text-white bg-primary"
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-user-1" role="tabpanel"
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <div class="pr-2">
                                @can('Create Location')
                                    <a href="#" class="btn btn-sm btn-icon  text-white bg-primary me-2" data-bs-toggle="tooltip"
                                            ...
                                            @foreach ($locations as $location)
                                                <tr data-name="{{ $location->name }}">
                                                    ...
                                                    <td class="Action">
                                                        ...
                                                        <div class="d-flex">
                                                            @can('Edit Location')
                                                                <a class="btn btn-sm btn-icon  text-white bg-info me-2"
                                                                    data-size="md"
                                                                    data-url="{{ route('location.edit', $location->id) }}"
                                                                    data-ajax-popup="true" data-title="{{ __('Edit Location') }}"
                                                        ...
                                                        <div class="d-flex">
                                                            @can('Edit Shipping')
                                                                <a class="btn btn-sm btn-icon  text-white bg-info me-2"
                                                                    ...
                                                                    data-ajax-popup="true" data-title="{{ __('Edit Shipping') }}"
                                                                    data-bs-toggle="tooltip" data-bs-placement="top"
                                                                    title="{{ __('Edit Shipping') }}">
                                                                    <i class="ti ti-pencil f-20"></i>
                                                                </a>
                                                            @endcan
                                                            @can('Delete Shipping')
