    ...
    <div class="modal-body">
        <div class="row">
            ...
            <a href="{{asset(Storage::url('uploads/sample')).'/sample-product.xlsx'}}" class="btn btn-sm btn-primary btn-icon-only rounded-circl" data-bs-toggle="tooltip" title="{{ __('Download') }}">
