    ...
    <div class="row  m-0">
        <div class="col-auto p-0 me-2 ">
            <a href="#" id="{{ env('APP_URL') . '/' . $store->slug . '/order/' . $order_id }}"
                class="btn btn-sm bg-blue-subtitle btn-icon mb-1" onclick="copyToClipboard(this)" title="Copy link"
                data-bs-toggle="tooltip" data-original-title="{{ __('Click to copy') }}"><i
                    class="ti ti-link text-white"></i></a>
        </div>
        <div class="col-auto p-0 me-2">
            <a href="{{ route('order.receipt', $order->id) }} " class="btn btn-sm bg-light-blue-subtitle btn-icon"
        ...
        <div class="col-auto p-0 me-2">
            <a href="# " onclick="saveAsPDF();" class="btn btn-sm bg-warning btn-icon" id="download-buttons"
