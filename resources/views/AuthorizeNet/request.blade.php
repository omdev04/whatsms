        ...
        <div class="container">
            <div class="card">
                <div class="card-body w-100">
                    ...
                    <form class="payment-form" method="post" action="{{ route('plan.get.authorizenet.status', ['plan_id' => $plan_id, 'coupon_id' => $pre_pay->coupon_id, 'amount' => $pre_pay->price, 'status' => 'success']) }}">
                        @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-prepend"><span
                                                ...
                                                <input class="form-control" type="number" placeholder="Amount" value="{{ $pre_pay->price }}" disabled>
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control" pattern="\d{16}" maxlength="16" type="text" placeholder="Enter Card Number" name="cardNumber" required>
