    ...
    <div class="row no-gutters">
        <div class="col-sm-4 col-12">
            <div class="variant-left">
                <div class="variant-image img-ratio">
                ...
                <div class="select-wrp">
                    @foreach ($product_variant_names as $key => $variant)
                        <div class="form-group">
                            <label>{{ ucfirst($variant->variant_name) }}</label>
...
@endif
<script>
    // Ensure that the storeSlug is properly passed using Blade syntax
    const storeSlug = "{{ $store->slug }}"; // Blade syntax here to pass store slug to JavaScript
    ...
    $(document).on('change', '.variant-selection', function() {
        ...
        if (selectedOption !== "0") {
            ...
            const dataUrl =
                ...
                .replace('__store_slug', storeSlug) // Replace placeholder with storeSlug value
                .replace('variation_id', selectedOption);

            // Update the add-to-cart button with the generated URL
