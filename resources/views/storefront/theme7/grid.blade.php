                                ...
                                <div class="product-card-inner">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-content-bottom">
                                            <div class="cart-btn-wrp d-flex align-items-end justify-content-between">
                                                <div class="price-wrp">
                                                ...
                                                @if ($flag != 'my_orders')
                                                    @if ($product->enable_product_variant == 'on')
                                                        <a href="#!" class="cart-btn btn-addcart modal-target"
                                                            data-size="md"
                                                    ...
                                                    @else
                                                        <a href="#!" class="cart-btn add_to_cart modal-target"
