...
class FeaturesController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with(['success' => __('Feature setting update successfully')]);
    }
    ...
    public function feature_update(Request $request, $key)
    {
        ...
        return redirect()->back()->with(['success' => __('Feature updated successfully')]);
    }
    ...
    public function features_store(Request $request)
    {
        ...
        return redirect()->back()->with(['success' => __('Feature block created successfully')]);
    }
    ...
    public function features_update(Request $request, $key)
    {
        ...
        return redirect()->back()->with(['success' => __('Feature block updated successfully')]);
    }
    ...
    public function features_delete($key)
    {
        ...
        return redirect()->back()->with(['success' => __('Feature block deleted successfully')]);
    }
}
