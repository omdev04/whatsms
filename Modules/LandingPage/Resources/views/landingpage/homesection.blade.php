                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-9 ">
                                    <div class="text-end">
                                    <button class="btn btn-sm btn-primary btn-icon m-1 me-2" data-repeater-create data-bs-toggle="tooltip" title="{{ __('Add') }}" type="button"><i class="ti ti-plus"></i></button>
                                    </div>
                                                ...
                                                <div class="px-2 py-2">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto actions">
                                                            <a data-repeater-delete href="javascript:void(0)" class="action-item btn btn-sm btn-icon bg-danger text-white repeater-action-btn ms-2" data-bs-toggle="tooltip" title="{{ __('Delete') }}">
                                            ...
                                            <div class="card mb-3 border shadow-none product_Image">
                                                <div class="px-2 py-2">
                                                    <div class="row align-items-center">
                                                        ...
                                                        <div class="col-auto actions">
                                                            <a class="action-item btn btn-sm btn-icon bg-primary text-white" href="{{ $logo.'/'.$home_logo }}" download="" data-bs-toggle="tooltip" title="{{__('Download')}}" data-original-title="Download">
                                                                <i class="ti ti-download"></i>
                                                            </a>
                                                        </div>
                                                        <div class="col-auto actions">
                                                            <a class="action-item btn btn-sm btn-icon bg-danger text-white delete-button" data-image="{{ $home_logo }}" data-bs-toggle="tooltip" title="{{__('Delete')}}">
                                                                <i class="ti ti-trash"></i>
                                                            </a>
                                                        </div>
                                                    </div>
