...
<div class="modal-body">
    ...
    <div class="row">
        <div class="form-group col-md-12">
            {{ Form::label('menubar_page_name', __('Page Name'), ['class' => 'form-label']) }} <x-required></x-required>
        ...
        <div class="form-group col-md-12 page_url d-none">
            ...
            {{ Form::text('page_url', null, ['class' => 'form-control font-style page_url_field', 'placeholder' => __('Enter Page URL')]) }}
        </div>
    ...
    $(document).ready(function() {
        ...
        $('input[name="template_name"]').change(function() {
            ...
            if (radioValue === "page_content") {
                ...
                $('.page_url_field').removeAttr('required');
            } else {
                $('.page_content').addClass('d-none');
                $('.page_url').removeClass('d-none');
                $('.page_url_field').attr('required',true);
            }
        });
    });
</script>
