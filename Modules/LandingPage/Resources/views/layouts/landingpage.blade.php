            ...
            <div class="row gy-3">
                <div class="col-xxl-4">
                    ...
                    @if ($settings['feature_buy_now_link'])
                        <a href="{{ $settings['feature_buy_now_link'] }}" class="btn btn-primary d-inline-flex align-items-center">{{__('Buy Now ')}}<i data-feather="lock" class="ms-2"></i></a>
                    @endif
                </div>
                <div class="col-xxl-8">
                    <div class="row">
                    ...
                    @if ($key % 2 == 0)
                        <div class="row align-items-center justify-content-center mb-4">
                            <div class="col-lg-4 col-md-6">
                                ...
                                <a href="{{ $value['other_feature_buy_now_link'] }}" class="btn btn-primary d-inline-flex align-items-center">{{__('Buy Now ')}}<i data-feather="lock" class="ms-2"></i></a>
                            </div>
        ...
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center flex-sm-row gap-3 mt-3">
                @if ($settings['discover_live_demo_link'])
                    <a href="{{ $settings['discover_live_demo_link'] }}" class="btn btn-outline-light">{{__('Live Demo ')}}<i data-feather="play-circle" class="ms-2"></i> </a>
                @endif
                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div class="card price-card shadow-none {{ $adminSettings['cust_darklayout'] == 'off' ? ($key == 1 ? 'bg-light-primary' : ($key == 2 ? 'bg-dark' : '')) : 'bg-dark' }}">
                            <div class="card-body">
                                ...
                                <div class="d-grid">
                                    @if(\Auth::user())
                                        <a href="{{ route('stripe', \Illuminate\Support\Facades\Crypt::encrypt($value->id)) }}" class="btn btn-primary">{{ __('Start with Starter') }} <i data-feather="log-in" class="ms-2"></i> </a>
                                    @else
                                        <a href="{{ route('register', ['plan' => \Illuminate\Support\Facades\Crypt::encrypt($value->id)]) }}" class="btn btn-primary">{{ __('Start with Starter') }} <i data-feather="log-in" class="ms-2"></i> </a>
                                    @endif
                                </div>
                            </div>
                        </div>
